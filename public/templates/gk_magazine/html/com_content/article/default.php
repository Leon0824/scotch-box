...
<article class="item-page<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Article">
	...
	<header>
		...
		<?php if (($params->get('show_create_date')) || ($params->get('show_publish_date')) || ($params->get('show_modify_date')) || $canEdit || $params->get('show_print_icon') || $params->get('show_email_icon') || $params->get('show_parent_category') && $this->item->parent_slug != '1:root' || $params->get('show_category') || $params->get('show_hits')) : ?>
		<ul>	
